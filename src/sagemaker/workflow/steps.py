...
class CompilationStep(ConfigurableRetryStep):
    """`CompilationStep` for SageMaker Pipelines Workflows."""
    ...
    def __init__(
        ...
        In addition to the `EstimatorBase` and `Model` instances, the other arguments are those that are
        supplied to the `compile_model` method of the `sagemaker.model.Model.compile_model`.

        Args:
            name (str): The name of the `CompilationStep`.
            estimator (EstimatorBase): A `sagemaker.estimator.EstimatorBase` instance.
            ...
            retry_policies (List[RetryPolicy]):  A list of retry policies.
            display_name (str): The display name of the CompilationStep`.
            description (str): The description of the `CompilationStep`.
            cache_config (CacheConfig):  A `sagemaker.workflow.steps.CacheConfig` instance.
        """
    ...
    @property
    def arguments(self) -> RequestType:
        """The arguments dictionary that is used to call `create_compilation_job`.
